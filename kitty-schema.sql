-- kitty-schema.sql
-- Full idempotent base schema — safe to re-run at any time.
...
-- Japan Trip seed data (INSERT OR IGNORE — safe to re-run)
INSERT OR IGNORE INTO trips (id, name, start_date, end_date, icon, cover_photo, code, created_at)
VALUES ('demo-japan-2025','Japan Trip 2025','2025-04-02','2025-04-12','✈️',NULL,'JAPAN1','2025-04-01T09:00:00Z');
...
INSERT OR IGNORE INTO expenses
  (id,trip_id,desc,amount,paid_by,date,note,category,split_between,paid_settlements,split_type,shares,created_at) VALUES
  ('exp-j1','demo-japan-2025','ANA Flights',             3200,'Marcus','2025-04-02','Round trip x4',       'transport','["Marcus","Elena","Dev","Sara"]','{}','even',NULL,'2025-04-02T09:00:00Z'),
  ('exp-j2','demo-japan-2025','Hotel Gracery – 5 nights',1100,'Elena', '2025-04-02','Shinjuku, great views','hotel',    '["Marcus","Elena","Dev","Sara"]','{}','even',NULL,'2025-04-02T09:05:00Z'),
  ('exp-j3','demo-japan-2025','Omakase dinner',           480,'Dev',   '2025-04-05','Best meal of my life', 'food',     '["Marcus","Elena","Dev","Sara"]','{}','even',NULL,'2025-04-05T20:00:00Z'),
  ('exp-j4','demo-japan-2025','Shinkansen passes',        340,'Sara',  '2025-04-06','7-day JR pass',        'transport','["Marcus","Elena","Dev","Sara"]','{}','even',NULL,'2025-04-06T10:00:00Z'),
  ('exp-j5','demo-japan-2025','TeamLab Planets',           96,'Marcus','2025-04-07','Skip-the-line tickets','activity', '["Elena","Dev","Sara"]',         '{}','even',NULL,'2025-04-07T14:00:00Z'),
  ('exp-j6','demo-japan-2025','Ramen tour – 3 spots',      68,'Elena', '2025-04-08','Ichiran was the best', 'food',     '["Marcus","Elena","Dev","Sara"]','{}','even',NULL,'2025-04-08T12:00:00Z'),
  ('exp-j7','demo-japan-2025','Sake tasting bar',          95,'Dev',   '2025-04-09','Ginza district',       'drinks',   '["Marcus","Elena","Dev","Sara"]','{}','even',NULL,'2025-04-09T20:00:00Z'),
  ('exp-j8','demo-japan-2025','Tsukiji market breakfast',  42,'Sara',  '2025-04-10','Fresh tuna bowls!',    'food',     '["Marcus","Elena","Dev","Sara"]','{}','even',NULL,'2025-04-10T08:00:00Z');
